...
describe(`Dropdown`, () => {
  ...
  it(`renders a focusable button that activates a dropdown`, () => {
    ...
    const dropdown = render(
      <Dropdown activatorText={activatorText} items={items} />
    );

    // getByTestId is a selector to be used with attribute 'data-testid'
