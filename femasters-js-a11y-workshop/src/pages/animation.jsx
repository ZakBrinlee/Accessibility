...
const friends = [
  {
    ...
    bio:
      "Doggo ipsum very hand that feed shibe heckin good boys and girls fat boi much ruin diet you are doing me the shock wrinkler length boy, I am bekom fat lotsa pats dat tungg tho shooberino.",
  ...
  },
  {
    ...
    bio:
      "The door is opening! how exciting oh, it's you, meh drink water out of the faucet. Spend six hours per day washing, but still have a crusty butthole, so lies down or sit on human they not getting up ever, but lick human with sandpaper tongue.",
    twitterLink: "http://twitter.com",
  },
];
  ...
  <Layout>
    ...
    <div>
      ...
      <section className="two-col">
        <div>
          <h3>
            Inaccessible animation demo <br />[
            <a href="https://github.com/marcysutton/js-a11y-workshop/blob/master/src/components/bad/card-flip.js">
              source 1
            </a>
            ]
          </h3>
        ...
        <div>
          <h3>
            Animation demo 2: add styles <br />[
            <a href="https://github.com/marcysutton/js-a11y-workshop/blob/master/src/components/better/card-flip.js">
              source 2
            </a>
            ]
          </h3>
