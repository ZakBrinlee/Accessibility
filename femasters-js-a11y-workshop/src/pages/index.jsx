...
const IndexPage = () => (
  <Layout>
    ...
    <div>
      ...
      <p>
        Here are some web accessibility tools, resources, and books for web
      ...
      <ul>
        ...
        <li>
          <a href="https://gist.github.com/marcysutton/0a42f815878c159517a55e6652e3b23a">
            Chrome Accessibility Inspector
          </a>
        </li>
        <li>
          <a href="https://developers.google.com/web/updates/2018/01/devtools#contrast">
            Chrome Color Contrast Debugger
          </a>
        </li>
        <li>
          <a href="https://marcysutton.com/angular-protractor-accessibility-plugin/">
            Protractor Accessibility Plugin
          </a>
        </li>
        <li>
          <a href="https://a11ysupport.io/">Accessibility Support matrix</a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="https://webaim.org/articles/voiceover/">Voiceover</a>
        </li>
        <li>
          <a href="https://webaim.org/articles/nvda/">NVDA</a>
        </li>
        <li>
          <a href="https://webaim.org/articles/jaws/">JAWS</a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="https://reactjs.org/docs/accessibility.html">Reactjs.org</a>
        </li>
        <li>
          <a href="https://guides.emberjs.com/release/reference/accessibility-guide/">
            Emberjs.com
          </a>
        </li>
        <li>
          <a href="https://angular.io/guide/accessibility">Angular.io</a>
        </li>
        <li>
          <a href="https://facebook.github.io/react-native/docs/accessibility">
            React Native
          </a>
        </li>
        <li>
          <a href="https://ionicframework.com/docs/native/mobile-accessibility">
